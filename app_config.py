...
PROJECT_SLUG = 'voxgrid-tornado'

# Project name to be used in file paths
PROJECT_FILENAME = 'voxgrid_tornado'

# The name of the repository containing the source
REPOSITORY_NAME = 'voxgrid-tornado'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '1pOT7l8gLnHod5dI5ZQlxQnvSZ7OUGiiIo3Ks_Yesldw'
