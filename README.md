...
**TKTK: Describe voxgrid-tornado here.**
...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=1pOT7l8gLnHod5dI5ZQlxQnvSZ7OUGiiIo3Ks_Yesldw#gid=0).
...
def read_my_google_doc():
    ...
    get_document('1pOT7l8gLnHod5dI5ZQlxQnvSZ7OUGiiIo3Ks_Yesldw', file_path)
    data = Copy(file_path)
...
```
* * * * * ubuntu bash /home/ubuntu/apps/voxgrid_tornado/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|voxgrid-tornado|tweet|`location`||
|voxgrid-tornado|facebook|`location`||
|voxgrid-tornado|email|`location`||
|voxgrid-tornado|new-comment||
|voxgrid-tornado|open-share-discuss||
|voxgrid-tornado|close-share-discuss||
|voxgrid-tornado|summary-copied||
|voxgrid-tornado|featured-tweet-action|`action`|
|voxgrid-tornado|featured-facebook-action|`action`|
